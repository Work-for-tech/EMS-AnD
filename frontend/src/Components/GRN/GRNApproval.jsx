    ...
    return (
        <div className='w-full flex flex-col'>
            ...
            <div className='flex flex-col items-center gap-2'>
                {
                    Purchase.length === 0 ? <div className="bg-white flex items-center justify-center flex-row w-full p-4 gap-4 rounded-md">
                        ...
                        <div className='w-full flex justify-center'>
                            <Select placeholder="Select Purchase" onChange={(e) => setPurchaseId(e)} className='w-1/2' options={Purchase.map((e) => {
                ...
                <Select className='w-1/2' onChange={(e) => { setGrnids(e) }} placeholder="Select GRN" options={grn.map((e) => {
                    return { label: e.invoice_number, value: e._id }
                })} />
                <Button className='w-1/2 bg-blue-700 text-white' onClick={() => HandleSubmit()}>Approve</Button>
            </div>
            <GRNApprovalList />
        </div>
    )
