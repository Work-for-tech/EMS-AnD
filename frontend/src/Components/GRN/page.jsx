    ...
    return (
        <div className='w-full flex justify-center'>
            <div className='flex w-full flex-col items-center gap-3'>
                <p className='p-5 text-center'>Create GRN</p>
                <p className='w-1/2 text-left'>Invoice Number</p>
                <Input className='w-1/2' onChange={(e) => setDataToSend({ ...dataToSend, invoiceNumber: e.target.value })} placeholder="Invoice Number" />
                <p className='w-1/2 text-left'>Received Date</p>
                <DatePicker className='w-1/2' onChange={(a, e) => setDataToSend({ ...dataToSend, receivedDate: e })} placeholder="Received Date" />
                ...
                <Upload className='w-1/2' onChange={(info) => {
                ...
                <Button className='w-1/2 bg-blue-700 text-white' onClick={() => HandleSubmit()} >Submit</Button>
            </div>
