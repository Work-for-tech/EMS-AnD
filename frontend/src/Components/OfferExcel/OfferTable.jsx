    ...
    return (
        <div className='w-full'>
            <Button className="bg-blue-700 text-white" onClick={() => {
                ...
                const worksheet = XLSX.utils.table_to_sheet(document.getElementById("TableToExport"));
            ...
            <table id="TableToExport" className='w-full text-center'>
                <tr>
                    <td className='text-red-900 font-semibold text-2xl' colSpan={9}>EMS PROJECTS PVT. LTD.</td>
                </tr>
                <tr>
                    <td className='text-left' colSpan={4}>Project Name : {offer.project_name}</td>
                </tr>
                <tr>
                    <td className='text-left' colSpan={4}>Client Name: {offer.client_name}</td>
                </tr>
                <tr>
                    <td className='text-left' colSpan={4}>Description of Panel: {offer.description_of_panel}</td>
                </tr>
                <tr>
                    <td className='text-left' colSpan={4}>Qty of Panel: {offer.Qty_of_panel}</td>
                </tr>
                                            ...
                                            return (
                                                <>
                                                    <tr>
                                                        ...
                                                        <td>{e.company.price * e.quantity * (1 - (e.company.discount / 100))}</td>
                                                    </tr>
                                                </>
                                            )
                                        })
                                        ...
                                        return (
                                            <>
                                                <tr>
                                                    ...
                                                    <td>{e.company.price}</td>
                                                    <td>{e.company.discount}  </td>
                                                    <td>{round(e.company.price * e.quantity * (1 - (e.company.discount / 100)), 3)}</td>
                                                </tr>
                                            </>
                                        )
                                    })
